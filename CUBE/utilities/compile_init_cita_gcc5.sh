...
module purge
module load gcc/5.4.0 openmpi/2.0.0-gcc-5.4.0 fftw/3.3.5-gcc-5.4.0-openmpi-2.0.0
...
mpif90 -O3 -cpp -fcoarray=single -mcmodel=medium -c initial_conditions.f90 -o initial_conditions.o  -lfftw3f -I/opt/fftw/3.3.5-gcc-5.4.0-openmpi-2.0.0/include/ -L/opt/fftw/3.3.5-gcc-5.4.0-openmpi-2.0.0/lib/ -lm -ldl

mpif90 -O3 -cpp -fcoarray=single -mcmodel=medium initial_conditions.o parameters.o penfft_config.o powerspectrum.o penfft_fine.o -o a.out  -lfftw3f -I/opt/fftw/3.3.5-gcc-5.4.0-openmpi-2.0.0/include/ -L/opt/fftw/3.3.5-gcc-5.4.0-openmpi-2.0.0/lib/ -lm -ldl
