...
mpif90 -O3 -cpp -fcoarray=single -c cafpower.f90 -o cafpower.o  -lfftw3f -I/usr/local/include/ -L/usr/local/lib/ -lm -ldl

mpif90 -O3 -cpp -fcoarray=single cafpower.o parameters.o penfft_config.o penfft_fine.o powerspectrum.o -o a.out  -lfftw3f -I/usr/local/include/ -L/usr/local/lib/ -lm -ldl
