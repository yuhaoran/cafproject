...
to improve the baryonic acoustic oscillation (BAO) measurements
...
\tcb{which is the limit of all possible Lagrangian reconstruction
formulations.}
The displacement field can be decomposed into a curl-less ``$E$-mode'' component
...
\tcb{and this Lagrangian $E$-mode recovery
 quantifies the upper limit of Lagrangian reconstruction methods.}
