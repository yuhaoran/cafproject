...
By using {\tt CUBE}, with parameters $n_\chi=n_\nu=1$, ${\tt nc}=384$, ${\tt nnt}=4$, ${\tt ncb}=6$, $\epsilon_{\rm image}=10\%$, $\epsilon_{\rm tile}=100\%$ and $\left\langle {\tt nplocal} \right\rangle=1536^3$, we use about 38.3 GB of memory, corresponding to 10.6 bpp. This can be done on most of the supercomputers, even laptops.
...
\hline
Particles  & \tt xvp          & 29.9   & 8.24   & 87.4\%     \\
           & \tt xvp\_new     & \underline{1.69}   & \underline{0.465}  & \underline{4.93\%}`     \\
           & \tt PID          & 0      & 0      &    0\%     \\
           & Subtotal         & 31.5   & 8.71   & 92.4\%     \\
\hline
Coarse mesh& \tt rho\_c       & 0.296  & 0.0818 & 0.870\%    \\
           & \tt vfield       & 0.889  & 0.245  & 2.60\%     \\
           & \tt kern\_c      & 0.340  & 0.0939 & 0.996\%    \\
           & \tt force\_c     & (0.690)  & (0.190)  & (2.02\%)    \\
           & \tt rho\_c\_new  & 0.0140 & 0.00388  & 0.0411\% \\
           & Pencil-FFT       & (0.454)  & (0.125) & (1.33\%)      \\
           & Subtotal         & 1.55   & 0.429 & 4.55\%     \\
\hline
Fine mesh  & \tt kern\_f      & 1.06   & 0.292 & 3.09\%      \\
           & \tt force\_f     & (1.63) & (0.450) & (4.77\%)     \\
           & Fine-FFT     &   (1.41) & (0.389) & (4.13\%)     \\
           & Subtotal      & 1.06   & 0.292 & 3.09\%      \\
\hline
Total &                      & 34.2 & 9.43 & 100\%\\
\hline
\multicolumn{2}{l} {Optimal limit} & 21.7 & 6 & 63.6\%\\
\hline
\end{tabular}
\end{table}
